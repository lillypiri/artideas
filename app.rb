...
get '/' do
  choices = [
    ...
    "An elaborate re-staging of the Teletubbies set: undulating green astro turfed hills populated by dogs of varying heights and breeds. Bagged dog excrement is arranged in a mandala pattern in the centre. An introspection into the history of domestication and the environmental concerns that accompany it.",
